...
describe('ExampleDataService', () => {
  ...
  describe('simulateRealTimeUpdates', () => {
    it(
      'should call callback with valid updates',
      async () => {
    ...
    it(
      'should generate updates for valid room IDs',
      async () => {
        const rooms = service.getExampleRooms();
    ...
    it(
      'should respect room capacity limits',
      async () => {
        const rooms = service.getExampleRooms();
  ...
  describe('stopSimulation', () => {
    it(
      'should stop generating updates',
      async () => {
        let updateCount = 0;
    ...
    it(
      'should allow restarting simulation after stop',
      async () => {
        let updateCount = 0;
        service.simulateRealTimeUpdates(() => {
          updateCount++;
